...
public class MicCtlPanel extends JPanel implements ActionListener {
  ...
  final static Font[] font = {
      new Font("Helvetica", Font.BOLD, 12), new Font("Helvetica", Font.BOLD, 9)};
  ...
  ButtonGroup delayGroup = new ButtonGroup(), speedGroup = new ButtonGroup();
  int[] initChoice = {0, 1};
  JButton reset = new JButton(new ImageIcon(getClass().getResource("/reset.gif"))),
          left = new JButton(new ImageIcon(getClass().getResource("/larrow.gif"))),
          right = new JButton(new ImageIcon(getClass().getResource("/rarrow.gif"))),
